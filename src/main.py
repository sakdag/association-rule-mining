...
if __name__ == "__main__":
    ...
    itemsets = arm.create_itemset(50, 3)
    #print(itemsets)

    pruned_itemsets = arm.generate_next_set_of_itemsets(itemsets, 3)
    #print(pruned_itemsets)

    naive_itemsets = arm.generate_next_set_of_naive_itemsets(itemsets, 3)
